...
export default function AccountSection({ user }: any) {
  ...
  return (
    <div className="pt-20 mx-4 space-y-20">
      ...
      <div className="flex flex-col items-center mt-16 w-full gap-y-5">
        ...
        >
          <div className="self-start w-full">
            ...
            <input className="border-b-2 bg-white w-full" disabled={isEdit ? false : true} type="text" placeholder={user.username || "not set"} required />
          </div>
          <div className="self-start w-full">
            <p className="font-medium text-darkGray text-opacity-70">Nama</p>
            <input className="border-b-2 bg-white w-full" disabled={isEdit ? false : true} type="text" placeholder={user.name || "not set"} required />
          </div>
          <div className="self-start w-full">
            <p className="font-medium text-darkGray text-opacity-70">Email</p>
            <input className="border-b-2 bg-white w-full" disabled type="text" value={user.email} />
          </div>
          {isEdit ? (
